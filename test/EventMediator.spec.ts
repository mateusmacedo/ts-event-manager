import { HandlerAlreadyRegisteredError } from '../src/application/error/HandlerAlreadyRegistered'
import { HandlerIsNotRegisteredError } from '../src/application/error/HandlerIsNotRegistered'
